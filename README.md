...
- `wheel_scroll_factor`: Sets the wheel scroll speed factor vertical/horizontal pair.
  - `vertical`: vertical scroll speed factor (float64).
  - `horizontal`: horizontal scroll speed factor (float64).
- `motion_scroll_factor`: Sets the motion scroll (with `scroll_button`) speed factor vertical/horizontal pair.
  - `vertical`: vertical scroll speed factor (float64).
  - `horizontal`: horizontal scroll speed factor (float64).
